  ...
  history: [
    {
      role: "user",
      parts: [
        {text: "Generate Travel Plan for Location : Las Vegas, for 3 Days for Couple with a Cheap budget ,Give me a 3 Hotels options list for every place I visit in Las Vegas with Hotel Name, Hotel address, Price, hotel image url, geo coordinates, rating, descriptions and suggest itinerary with place Name, Place Details, Place Image Url, Geo Coordinates, ticket Pricing, rating, Time travel each of the location for 3 days with each day plan with best time to visit in JSON format"},
      ],
    },
    {
      role: "model",
...
//         {
//           text: `
// Generate a detailed 3-day travel itinerary for Las Vegas for a couple on a cheap budget. 
// The output must be in valid JSON.

// Requirements:
// 1. Hotels: For each day, suggest 3 affordable hotel options with:
//    - name, address, price, rating, image_url, geo_coordinates, description
// 2. Itinerary: For each day, provide a timeline with detailed activities, including:
//    - exact time slots (hourly if possible)
//    - place name
//    - place details
//    - image_url
//    - geo_coordinates
...
//    - budget food options near each attraction
//    - 1–2 alternative activities if primary is crowded/closed
// 3. Keep the format consistent in JSON.
